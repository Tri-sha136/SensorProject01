...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        ...
        try:
            logging.info(f"splitting traing and testing input and target features")
            ...
            #to get best model nmae from dict
            ...
            best_model_score = accuracy_score(y_train,y_pred)

            print(f"best_model_name":{best_model_name},"best_model_score":{best_model_score})


            if best_model_score<0.5:
                raise Exception("no best model is found with accuracy grater than 50%")
